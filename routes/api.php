...
Route::group(['prefix' => '/v1'/*, 'middleware' => 'auth.basic.once'*/], function () {
    ...
    Route::apiResource('lessons', LessonController::class)/*->withMiddleware('auth.basic.once')*/;
    Route::apiResource('users', UserController::class)/*->withoutMiddleware('auth.basic.once')*/;
